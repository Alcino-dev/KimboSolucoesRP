...
const slides = [
  {
    ...
    subtitle:
      "Soluções completas em desinfestação, limpeza, jardinagem e climatização",
  },
  {
    image: "img2.webp",
    title: "Desinfestação Profissional",
    subtitle:
      "Proteja sua casa e empresa contra pragas com nossos serviços especializados",
  },
  {
    image: "img3.webp",
    title: "Limpeza Profunda",
    subtitle:
      "Ambientes higienizados e livres de impurezas para seu conforto e segurança",
  },
  {
    image: "img4.webp",
    title: "Soluções em Climatização",
    subtitle:
      "Instalação e manutenção de sistemas de climatização para seu bem-estar",
  },
];
    ...
    <main className="relative min-h-screen">
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="absolute bottom-40 ml-5 md:bottom-32 right-4 md:right-8 z-30 flex items-center space-x-4">
          <Link href="/Clientes" className="text-white hover:text-[#ffd200]">
            Conheça nossos clientes
          </Link>
          <div className="h-8 w-px bg-[#ffd200]" />
          <span className="text-white">Nossas redes:</span>
          <a
            href="https://www.linkedin.com/in/kimbo-solu%C3%A7%C3%B5es-246b4a27b/"
            className="text-white hover:text-green-400"
          >
            <Linkedin size={20} />
          </a>
          <a
            href="https://www.instagram.com/servicoskimbo/"
            className="text-white hover:text-green-400"
          >
            <Instagram size={20} />
          </a>
          <a
            href="https://www.facebook.com/profile.php?id=100076839086708"
            className="text-white hover:text-green-400"
          >
            <Facebook size={20} />
          </a>
